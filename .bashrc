...
export PATH="$HOME/.cargo/bin:$HOME/bin:$HOME/.cabal/bin:$HOME/.ghcup/bin:$PATH"
export VISUAL="vim"

if [ -e /home/hazelgrace/.nix-profile/etc/profile.d/nix.sh ]; then . /home/hazelgrace/.nix-profile/etc/profile.d/nix.sh; fi # added by Nix installer
